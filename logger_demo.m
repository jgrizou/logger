...
recCopy1.rm_field({'a', 'b'})
% You can replace a field, which simply do a rm_field followed by a log_field 
recCopy1.replace_field('variableC', 'toto')
% Check the results and difference between rec1 and recCopy1
